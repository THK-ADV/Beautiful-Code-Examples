...
class Playground {
    ...
    fun isCellOnBoard(cell: Cell) = isCellOnBoard(cell.rowIndex, cell.colIndex)
    fun isCellOnBoard(rowIndex: Int, colIndex: Int) = isValidIndex(rowIndex) && isValidIndex(colIndex)
